        ...
        <section className="section">
          <div className="content-card">
            <div className="section-header">
              <div className="eyebrow">Featured Experts</div>
            ...
            <div className="grid-3">
              <div className="feature-card">
                ...
                <div className="expert-meta">
                  <span className="expert-skills">React, Node.js, AWS</span>
                  <span className="expert-location">San Francisco</span>
                </div>
              </div>
              <div className="feature-card">
                ...
                <div className="expert-meta">
                  <span className="expert-skills">UX/UI, Figma, Accessibility</span>
                  <span className="expert-location">Remote</span>
                </div>
              </div>
              <div className="feature-card">
                <h3>Priya Patel</h3>
                ...
                <div className="expert-meta">
                  <span className="expert-skills">Growth, Community, Analytics</span>
                  <span className="expert-location">New York</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="section">
          <div className="content-card">
            <div className="section-header">
              ...
              <h2 className="section-title">
                Find experts with the skills you need
              </h2>
            </div>
            <div className="grid-3">
              <div className="feature-card">
